...
function SessionCard({ 
  ...
  useEffect(() => {
    ...
    const loadMap = async () => {
      ...
      // Calculate bounds from completed runs
  ...
  }, [isExpanded, uniqueRuns, mapLoaded])
    ...
    <div className="bg-gray-800/50 rounded-xl border border-white/10 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Top speed */}
          {session.top_speed_kmh > 0 && (
            <div className="text-right">
              <div className="text-lg font-bold text-white">{session.top_speed_kmh.toFixed(0)}</div>
